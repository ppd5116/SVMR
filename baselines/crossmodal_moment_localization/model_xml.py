...
class XML(nn.Module):
    ...
    def forward(self, query_feat, query_mask, video_feat, video_mask, sub_feat, sub_mask,
        ...
        # ========================================
        # Contextual encoding 
        video_feat1, video_feat2, sub_feat1, sub_feat2 = None
        # Get predicted start time and end time
        query_context_scores, st_prob, ed_prob = None
        # ========================================
    ...
    def get_pred_from_raw_query(self, query_feat, query_mask,
        ...
        # ========================================
        # Encode query
        video_query, sub_query = None
        divisor = self.use_sub + self.use_video

        # Get video-level retrieval scores
        video_q2ctx_scores = None if self.use_video else 0
        sub_q2ctx_scores = None if self.use_sub else 0
